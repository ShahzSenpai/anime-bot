...
```bash
> git clone https://github.com/ShahzSenpai/anime-bot
```
...
### Usage
Before running this script, first edit [this section](https://github.com/ShahzSenpai/anime-bot/blob/master/msgHndlr.js#L67) with your WhatsApp number, remember your WhatsApp number!  Not a bot number, then
```bash
> npm start
```
